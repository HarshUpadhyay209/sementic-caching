...
class FAQDataContainer:
    def __init__(self):
        self.faq_df = pd.read_csv("/home/harsh/Desktop/sementic-caching/utils/data/faq_seed.csv")
        self.test_df = pd.read_csv("/home/harsh/Desktop/sementic-caching/utils/data/test_dataset.csv")
